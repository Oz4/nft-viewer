...
const Details = ({
  ...
  const CollectionNameWithOwnerIndication = () => (
  ...
  const NFTName = () => (
    <Text fontSize="var(--lr-font-size-40)" fontWeight="bold" mb="1rem">
      {name}
    </Text>
  )

  const NFTDescription = () => (
    <Box fontSize="var(--lr-font-size-14)" fontWeight="bold" display="flex" mb="1rem">
  ...
  const Owner = () => (
    <Flex h="50px" align="center" mb="1rem">
      ...
      <Flex direction="column" ml="0.5rem" mr="0.5rem" lineHeight="1.3">
        <Text fontSize="var(--lr-font-size-12)" color="var(--lr-font-color-100)">
          Owner
        </Text>
        <Text fontSize="var(--lr-font-size-14)" color="var(--lr-color-accent-green)" fontWeight="bold">
  ...
  return (
    <Flex direction="column" width="100%">
      ...
      <CollectionNameWithOwnerIndication />
